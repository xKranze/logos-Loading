...
//New Class is to allocate space for the class using its same properties with out modifying/messing up the original class so other new contructors can share them.
//-----------------------------------------------------------------------------------
